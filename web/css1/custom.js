$(function(){
	...
	var stage_width = image_width * image_count+80;
	// Xác định chiều rộng của khung hiển thị slide
	var display_width = display_image_number * image_width + 80;
	...
	function right_slide_circle(){
		...
		$('.slide-stage').css("left",-image_width- 20 +"px"); // Dịch chuyển tức thời vị trí của stage sang một khoảng bằng 1 slide-image
